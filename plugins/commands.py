...
async def help(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("How to Deploy?", url="https://t.me/Kopaing15"),
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("BOT Owner", url="https://t.me/KOPAING15"),
                    InlineKeyboardButton("Support Group", url="https://t.me/MKS_RequestGroup")
                ]
            ]
        ),
        reply_to_message_id=message.message_id
